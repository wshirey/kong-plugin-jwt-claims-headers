...
convention of `X-claim-<claim-name>`. For example, if the JWT payload object is
...
```
X-claim-Sub   : "1234567890"
X-claim-Name  : "John Doe"
X-claim-Admin : true
```
...
`cookie_names`|*optional*|A list of cookies that Kong will inspect to retrieve JWTs. Defaults to `jwt`.
